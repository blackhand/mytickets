...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.presentation'
        db.add_column('ticket_ticket', 'presentation', models.ForeignKey(orm.Presentation))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Ticket.presentation'
        db.delete_column('ticket_ticket', 'presentation_id')
