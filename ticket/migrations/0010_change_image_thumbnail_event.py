...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ticket_event', 'image', ImageWithThumbnailsField(extra_thumbnails={'icon':{'size':(16,16),'options':['crop','upscale']},'small':{'size':(100,100)},'medium':{'size':(200,200)},'large':{'size':(400,400)},}, null=True, thumbnail={'size':(300,300)}, blank=True))
