...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.is_prominent'
        db.add_column('ticket_event', 'is_prominent', models.BooleanField(default=False))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Event.is_prominent'
        db.delete_column('ticket_event', 'is_prominent')
