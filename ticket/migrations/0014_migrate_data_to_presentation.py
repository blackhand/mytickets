...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # migrate zones from events to presentations
        # migrate auditorium too
        for event in orm.Event.objects.all():
            for presentation in event.presentation_set.all():
                presentation.auditorium = event.auditorium
                presentation.event = event
                for zone in event.zone_set.all():
                    presentation.zone_set.add(zone)
                presentation.save()

    def backwards(self, orm):
        "Write your backwards migration here"
        print "there is no backwards here"
