...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Auditorium.image'
        db.add_column('ticket_auditorium', 'image', ImageWithThumbnailsField(extra_thumbnails={'icon':{'size':(16,16),'options':['crop','upscale']},'small':{'size':(100,100)},'large':{'size':(400,400)},}, null=True, thumbnail={'size':(200,200)}, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Auditorium.image'
        db.delete_column('ticket_auditorium', 'image')
